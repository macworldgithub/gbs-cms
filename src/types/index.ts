...
export interface EventContextType {
  ...
  loading: boolean;
  error: string | null;
  searchEvents: (query: string, state?: string) => Promise<Event[]>;
  addEvent: (
  ...
  deleteEvent: (id: string) => Promise<void>;
  fetchEvents: (state?: string) => Promise<void>;
  bookEvent: (id: string) => Promise<void>;
...
export interface LanguageContextType {
  ...
  updateLanguage: (
    id: string,
    language: Partial<LanguageFormData>
  ) => Promise<void>;
  deleteLanguage: (id: string) => Promise<void>;
  selectLanguage: (id: string) => Promise<void>;
  fetchLanguages: () => Promise<void>;
