...
// import { Card } from "../ui/card";
// import { eventService } from "../../services/eventService";
// import MapboxPolygonDrawer from "../MapBoxPolygonDrawer"; // ✅ Added Mapbox Drawer
...
//   const [stateFilter, setStateFilter] = useState<string>("All");
//   const [filteredEvents, setFilteredEvents] = useState<Event[]>([]);
//   const [mapboxCoordinates, setMapboxCoordinates] = useState("[]"); // ✅ For Mapbox Drawer
...
//       isPopular: event.isPopular,
//     });
//     setMapboxCoordinates(JSON.stringify(event.area?.coordinates || [])); // ✅ Restore polygon
//     const roleNames = roles
//       .filter((role) => event.roles.includes(role._id))
//       .map((role) => role.name);
//     setSelectedRoleNames(roleNames);
...
//                 {/* Mapbox Drawer for Polygon */}
//                 <div className="md:col-span-2">
//                   <label className="block text-sm font-medium text-gray-700 mb-1">
//                     GeoJSON Area (Draw Polygon on Map)
//                   </label>
//                   <MapboxPolygonDrawer
...
//                         {event.isPopular ? "Featured" : "Mark as Featured"}
//                       </button>
//                     </div>
//                   </div>
//                 </div>
