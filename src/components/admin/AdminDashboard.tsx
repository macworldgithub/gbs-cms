...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform md:transform-none md:static transition-transform duration-300 ease-in-out ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
          <Card className="p-4 md:p-6">
            <div className="flex items-center justify-between">
              ...
              <UsersIcon className="w-6 h-6 md:w-8 md:h-8 text-[#ec2227]" />
            </div>
          </Card>
          ...
          <Card className="p-4 md:p-6">
            <div className="flex items-center justify-between">
              ...
              <BarChart3Icon className="w-6 h-6 md:w-8 md:h-8 text-[#ec2227]" />
            </div>
          </Card>
          ...
          <Card className="p-4 md:p-6">
            <div className="flex items-center justify-between">
              ...
              <Gift className="w-6 h-6 md:w-8 md:h-8 text-[#ec2227]" />
            </div>
          </Card>
          ...
          <Card className="p-4 md:p-6">
            <div className="flex items-center justify-between">
              ...
              <ShieldIcon className="w-6 h-6 md:w-8 md:h-8 text-[#ec2227]" />
            </div>
          </Card>
        </div>
      )}
